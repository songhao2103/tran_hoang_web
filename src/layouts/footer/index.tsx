...
const Footer = () => {
  return (
    <div className="bg-dark p-10 flex justify-center w-full mt-[50px] md:mt-[100px] xl:mt-[150px] flex-col lg:flex-row">
      <div className="flex max-w-[1820px] gap-x-[100px] flex-col lg:flex-row gap-y-6">
        <div className="flex flex-col gap-y-6 justify-center lg:justify-start items-center lg:items-start">
        ...
        <div className="max-w-[400px] h-[250px] overflow-hidden mt-2 lg:mt-0">
          <iframe
